...
function mergeQuickbaseDefaults(defaults: StudioDocument["quickbase"], source?: Partial<StudioDocument["quickbase"]>) {
  ...
  return {
    ...
    helpdeskAppDbid: resolve("helpdeskAppDbid"),
    helpdeskTicketsTableDbid: resolve("helpdeskTicketsTableDbid"),
    helpdeskParentTableDbid: resolve("helpdeskParentTableDbid"),
    helpdeskParentAppIdFid: resolve("helpdeskParentAppIdFid"),
    ...
    objectPersonalOwnerFieldId: resolve("objectPersonalOwnerFieldId"),
    objectUpdatedAtFieldId: resolve("objectUpdatedAtFieldId"),
    objectUpdatedByFieldId: resolve("objectUpdatedByFieldId"),
    rosterTableId: resolve("rosterTableId"),
    rosterUserIdFieldId: resolve("rosterUserIdFieldId"),
    rosterEmployeeNameFieldId: resolve("rosterEmployeeNameFieldId"),
    rosterEmployeeEmailFieldId: resolve("rosterEmployeeEmailFieldId"),
    rosterEmployeeRecordIdFieldId: resolve("rosterEmployeeRecordIdFieldId"),
    ...
    Object.entries(source.bundle?.objects || defaults.bundle.objects).map(([id, object]) => {
      if (object.type === "report") {
        ...
        return [id, {
          ...
          sharedUserIds: Array.isArray(object.sharedUserIds) ? object.sharedUserIds.map(String).filter(Boolean) : [],
